...
namespace Blockbuster_Lab
{
    class Blockbuster
    {
        ...
        public Blockbuster()
        {
            ...
            List<string> dScenes = new List<string> { "Beatrice takes her aptitude test", "The Choosing Ceremony", "Welcome to Dauntless", "Tris gets beat up by Peter", "Tris visits Caleb", "Tris goes into Four's fear simulation", "Erudite mind controls Dauntless", "Tris saves the day... for now" };
